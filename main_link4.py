...
input_h_train = np.reshape(input_h_temp[:16000,:],[-1,16])
...
input_h_test = np.reshape(input_h_temp[:4000,:],[-1,16])

Layer_dim_list = [16, R.shape[1]*no_link*no_pkt+C.shape[1]*no_link*no_pkt + no_link]
...
for l_idx in range(lr.shape[0]):
    ...
    with open(lr_path + '\R_link1_dnn_test.dat', 'w') as f3, open(lr_path + '\R_link2_dnn_test.dat', 'w') as f4, open(lr_path + '\capa_dnn_test.dat', 'w') as f5:
        pass
    with open(lr_path + '\R_link3_dnn_test.dat', 'w') as f6, open(lr_path + '\R_link4_dnn_test.dat', 'w') as f7:
        pass
    with open(lr_path + '\Cx3_link1_dnn_test.dat', 'w') as f8, open(lr_path + '\Cx3_link2_dnn_test.dat', 'w') as f9:
        pass
    with open(lr_path + '\Cx3_link3_dnn_test.dat', 'w') as f10, open(lr_path + '\Cx3_link4_dnn_test.dat', 'w') as f11:
        pass
